...
const desc1 = (
  <div style={{ fontSize: 12, color: 'rgba(0, 0, 0, 0.45)', position: 'relative', left: 42 }}>
    <div style={{ margin: '8px 0 4px' }}>
      刘泽阳<Icon style={{ marginLeft: 8 }} type="dingding-o" />
    </div>
...
const desc2 = (
  <div style={{ fontSize: 12, position: 'relative', left: 42 }}>
    <div style={{ margin: '8px 0 4px' }}>
      刘泽斌<Icon type="dingding-o" style={{ color: '#00A0E9', marginLeft: 8 }} />
    </div>
...
const extra = (
  <div>
    ...
    <Steps style={{ marginLeft: -42, width: 'calc(100% + 84px)' }} progressDot current={1}>
      <Step title={<span style={{ fontSize: 14 }}>创建任务</span>} description={desc1} />
      <Step title={<span style={{ fontSize: 14 }}>领导审批</span>} description={desc2} />
      <Step title={<span style={{ fontSize: 14 }}>现场执法</span>} />
